...
class DBConnect {
    ...
    public function auth(){
        ...
        if(! isset($_SESSION['username'])){
            header("Location: http://localhost/online-blood-bank-management-system-in-php-master/admin");
        }
    }
    ...
    public function checkAuth(){
        session_start();
        if(isset($_SESSION['username'])){
            header("Location: http://localhost/online-blood-bank-management-system-in-php-master/admin/home.php");
        }
    }
